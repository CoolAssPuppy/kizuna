...
insert into public.users (id, email, role, is_leadership, hibob_id, sponsor_id, auth_provider, is_active)
select user_id::uuid, email, role::user_role, is_leadership, 'hibob_' || replace(user_id, '-', ''), null, 'sso', true
from (values
  -- Executive (super_admin / admin) — entire C-suite is also leadership.
  ('a0000000-0000-0000-0000-000000000001', 'jean-luc.picard@kizuna.dev',     'super_admin', true),
  ('a0000000-0000-0000-0000-000000000002', 'kathryn.janeway@kizuna.dev',     'admin',       true),
  ('a0000000-0000-0000-0000-000000000003', 'benjamin.sisko@kizuna.dev',      'admin',       true),
  ('a0000000-0000-0000-0000-000000000004', 'jonathan.archer@kizuna.dev',     'admin',       true),
  -- Engineering (employees)
  ('a0000000-0000-0000-0000-000000000010', 'luke.skywalker@kizuna.dev',      'employee', false),
  ('a0000000-0000-0000-0000-000000000011', 'leia.organa@kizuna.dev',         'employee', true),
  ('a0000000-0000-0000-0000-000000000012', 'han.solo@kizuna.dev',            'employee', false),
  ('a0000000-0000-0000-0000-000000000013', 'rey.skywalker@kizuna.dev',       'employee', false),
  ('a0000000-0000-0000-0000-000000000014', 'finn.fn2187@kizuna.dev',         'employee', false),
  ('a0000000-0000-0000-0000-000000000015', 'poe.dameron@kizuna.dev',         'employee', false),
  ('a0000000-0000-0000-0000-000000000016', 'obi-wan.kenobi@kizuna.dev',      'employee', false),
  ('a0000000-0000-0000-0000-000000000017', 'padme.amidala@kizuna.dev',       'employee', false),
  ('a0000000-0000-0000-0000-000000000018', 'mace.windu@kizuna.dev',          'employee', false),
  ('a0000000-0000-0000-0000-000000000019', 'ahsoka.tano@kizuna.dev',         'employee', false),
  ('a0000000-0000-0000-0000-00000000001a', 'lando.calrissian@kizuna.dev',    'employee', false),
  ('a0000000-0000-0000-0000-00000000001b', 'cassian.andor@kizuna.dev',       'employee', false),
  ('a0000000-0000-0000-0000-00000000001c', 'jyn.erso@kizuna.dev',            'employee', false),
  ('a0000000-0000-0000-0000-00000000001d', 'din.djarin@kizuna.dev',          'employee', false),
  -- Marketing (employees)
  ('a0000000-0000-0000-0000-000000000020', 'harry.potter@kizuna.dev',        'employee', false),
  ('a0000000-0000-0000-0000-000000000021', 'hermione.granger@kizuna.dev',    'employee', true),
  ('a0000000-0000-0000-0000-000000000022', 'ron.weasley@kizuna.dev',         'employee', false),
  ('a0000000-0000-0000-0000-000000000023', 'minerva.mcgonagall@kizuna.dev',  'employee', true),
  ('a0000000-0000-0000-0000-000000000024', 'albus.dumbledore@kizuna.dev',    'employee', true),
  ('a0000000-0000-0000-0000-000000000025', 'sirius.black@kizuna.dev',        'employee', false),
  ('a0000000-0000-0000-0000-000000000026', 'remus.lupin@kizuna.dev',         'employee', false),
  ('a0000000-0000-0000-0000-000000000027', 'rubeus.hagrid@kizuna.dev',       'employee', false),
  ('a0000000-0000-0000-0000-000000000028', 'luna.lovegood@kizuna.dev',       'employee', false),
  ('a0000000-0000-0000-0000-000000000029', 'neville.longbottom@kizuna.dev',  'employee', false),
  ('a0000000-0000-0000-0000-00000000002a', 'ginny.weasley@kizuna.dev',       'employee', false),
  ('a0000000-0000-0000-0000-00000000002b', 'cho.chang@kizuna.dev',           'employee', false),
  ('a0000000-0000-0000-0000-00000000002c', 'cedric.diggory@kizuna.dev',      'employee', false),
  ('a0000000-0000-0000-0000-00000000002d', 'fleur.delacour@kizuna.dev',      'employee', false),
  -- Sales (employees)
  ('a0000000-0000-0000-0000-000000000030', 'william.adama@kizuna.dev',       'employee', true),
  ('a0000000-0000-0000-0000-000000000031', 'laura.roslin@kizuna.dev',        'employee', false),
  ('a0000000-0000-0000-0000-000000000032', 'kara.thrace@kizuna.dev',         'employee', false),
  ('a0000000-0000-0000-0000-000000000033', 'lee.adama@kizuna.dev',           'employee', false),
  ('a0000000-0000-0000-0000-000000000034', 'saul.tigh@kizuna.dev',           'employee', false),
  ('a0000000-0000-0000-0000-000000000035', 'galen.tyrol@kizuna.dev',         'employee', false),
  ('a0000000-0000-0000-0000-000000000036', 'karl.agathon@kizuna.dev',        'employee', false),
  ('a0000000-0000-0000-0000-000000000037', 'sharon.valerii@kizuna.dev',      'employee', false),
  ('a0000000-0000-0000-0000-000000000038', 'gaius.baltar@kizuna.dev',        'employee', false),
  ('a0000000-0000-0000-0000-000000000039', 'caprica.six@kizuna.dev',         'employee', false),
  ('a0000000-0000-0000-0000-00000000003a', 'helena.cain@kizuna.dev',         'employee', false),
  ('a0000000-0000-0000-0000-00000000003b', 'samuel.anders@kizuna.dev',       'employee', false),
  ('a0000000-0000-0000-0000-00000000003c', 'anastasia.dualla@kizuna.dev',    'employee', false),
  ('a0000000-0000-0000-0000-00000000003d', 'felix.gaeta@kizuna.dev',         'employee', false),
  -- Support (employees)
  ('a0000000-0000-0000-0000-000000000040', 'homer.simpson@kizuna.dev',       'employee', true),
  ('a0000000-0000-0000-0000-000000000041', 'marge.simpson@kizuna.dev',       'employee', false),
  ('a0000000-0000-0000-0000-000000000042', 'lisa.simpson@kizuna.dev',        'employee', false),
  ('a0000000-0000-0000-0000-000000000043', 'bart.simpson@kizuna.dev',        'employee', false),
  ('a0000000-0000-0000-0000-000000000044', 'ned.flanders@kizuna.dev',        'employee', false),
  ('a0000000-0000-0000-0000-000000000045', 'moe.szyslak@kizuna.dev',         'employee', false),
  ('a0000000-0000-0000-0000-000000000046', 'apu.nahasapeemapetilon@kizuna.dev', 'employee', false),
  ('a0000000-0000-0000-0000-000000000047', 'krusty.clown@kizuna.dev',        'employee', false),
  ('a0000000-0000-0000-0000-000000000048', 'monty.burns@kizuna.dev',         'employee', true),
  ('a0000000-0000-0000-0000-000000000049', 'waylon.smithers@kizuna.dev',     'employee', false),
  ('a0000000-0000-0000-0000-00000000004a', 'milhouse.vanhouten@kizuna.dev',  'employee', false),
  ('a0000000-0000-0000-0000-00000000004b', 'seymour.skinner@kizuna.dev',     'employee', false),
  ('a0000000-0000-0000-0000-00000000004c', 'clancy.wiggum@kizuna.dev',       'employee', false),
  ('a0000000-0000-0000-0000-00000000004d', 'edna.krabappel@kizuna.dev',      'employee', false)
) as t(user_id, email, role, is_leadership)
on conflict (id) do nothing;
...
insert into public.guest_invitations (sponsor_id, guest_email, first_name, last_name, age_bracket, fee_amount, signed_token, status, expires_at)
values
...
insert into public.additional_guests (sponsor_id, first_name, last_name, age_bracket, fee_amount, payment_status)
values
