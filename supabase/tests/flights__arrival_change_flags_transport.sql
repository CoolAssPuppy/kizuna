...
insert into public.flights (id, user_id, direction, origin, destination, departure_at, arrival_at, source)
values ('00000000-0000-0000-0000-0000000000f1',
        '00000000-0000-0000-0000-000000000020',
        'inbound', 'SFO', 'YYC',
        '2027-04-01 10:00:00+00', '2027-04-01 13:00:00+00',
        'manual_obs');

insert into public.transport_requests (id, user_id, flight_id, direction, pickup_datetime, passenger_count)
values ('00000000-0000-0000-0000-0000000000c1',
        '00000000-0000-0000-0000-000000000020',
        '00000000-0000-0000-0000-0000000000f1',
        'arrival',
        '2027-04-01 13:30:00+00',
        1);
